  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex gap-10">
        <div className="max-w-[250px] max-h-[82vh] overflow-y-auto scrollbar-hide flex flex-col gap-2 px-4">
          ...
          {sortedBackupList.map((item, idx) => (
            <div
              ...
              className={`w-full border border-gray-200 rounded-md transition-all duration-300 bg-white shadow-2xs px-4 py-2 flex flex-col gap-2 ${
                selectedFilename === item.filename ? "scale-105 shadow-2xl" : ""
              }`}
            >
        ...
        {backupData && (
          <div className="flex flex-col">
            <h1 className="text-lg font-bold mb-3">Logs Info</h1>
            <div className="flex gap-10">
              <div className="mx-5 lg:mx-0 rounded-md border border-gray-300 border-t-0 overflow-x-auto min-w-[800px] max-h-[82vh] bg-white overflow-y-auto scrollbar-hide">
              ...
              <button
                ...
                className="h-fit inline-block px-6 py-3 mr-3 font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer bg-gradient-to-tl from-purple-700 to-pink-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Rollback
              </button>
            </div>
